...
class WanTransformer3DModel_Sparse(WanTransformer3DModel):
    def forward(
        ...
        # logger.info(f"Transformer input hidden_states shape: {hidden_states.shape}")
        # logger.info(f"encoder_hidden_states shape: {encoder_hidden_states.shape}")
        # logger.info(f"encoder_hidden_states_image shape: {encoder_hidden_states_image.shape if encoder_hidden_states_image is not None else 'None'}")
        ...
        # logger.info(f"after condition embedder:")
        # logger.info(f"encoder_hidden_states shape: {encoder_hidden_states.shape if encoder_hidden_states is not None else 'None'}, encoder_hidden_states_image shape: {encoder_hidden_states_image.shape if encoder_hidden_states_image is not None else 'None'}")
