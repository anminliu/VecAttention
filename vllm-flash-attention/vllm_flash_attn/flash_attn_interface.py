...
try:
    from . import _vllm_fa2_C_sparse  # noqa: F401
...
def flash_attn_varlen_func(
    ...
    if fa_version == 2:
        ...
        out, softmax_lse = torch.ops._vllm_fa2_C_sparse.varlen_fwd(
            q, k, v,
            out,
            cu_seqlens_q,
...
def flash_attn_with_kvcache(
    ...
    *,
    ...
    out, softmax_lse = torch.ops._vllm_fa2_C_sparse.fwd_kvcache(
        q, k_cache, v_cache,
        k, v,             # k_new, v_new
        cache_seqlens,
        rotary_cos,
...
def sparse_attn_func(
    ...
    *,
    ...
    q, k, v = [maybe_contiguous(x) for x in (q, k, v)]
    out, softmax_lse = torch.ops._vllm_fa2_C_sparse.fwd_sparse(
        q,
        k,
        v,
        block_size,
...
def sparse_attn_varlen_func(
    ...
    *,
    ...
    q, k, v = [maybe_contiguous(x) for x in (q, k, v)]
    out, softmax_lse = torch.ops._vllm_fa2_C_sparse.varlen_fwd_sparse(
        q,
        k,
        v,
        block_size, 
